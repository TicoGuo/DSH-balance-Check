	...
	factory: (require) => {
		...
		*/
		...
		function BalanceButton({ queryBalance, openRecharge }) {
			...
			const measurePopoverHeight = (0, react.useCallback)(() => {
				const rect = rootRef.current?.getBoundingClientRect();
				const spaceAbove = rect !== void 0 ? rect.top - 12 : void 0;
				setPopoverMaxHeight(spaceAbove !== void 0 && spaceAbove > 0 ? spaceAbove : void 0);
			}, []);
			(0, react.useEffect)(() => {
				if (!open) return;
				...
				return () => {
					window.removeEventListener("resize", measurePopoverHeight);
				};
