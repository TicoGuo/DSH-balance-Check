window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css$1 = ".nft0-a_root{display:inline-flex;position:relative}.nft0-a_trigger{height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:24px;align-items:center;gap:4px;padding:0 4px 0 8px;font-size:13px;line-height:20px;transition:background-color .12s,border-color .12s;display:inline-flex}.nft0-a_trigger:hover{background:var(--dsw-alias-interactive-bg-hover)}.nft0-a_label{font-variant-numeric:tabular-nums;font-weight:500}.nft0-a_popover{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);width:264px;max-width:calc(100vw - 24px);color:var(--dsw-alias-label-primary);box-shadow:var(--dsw-shadow-lv3,0 8px 24px #00000059);z-index:1000;box-sizing:border-box;overscroll-behavior:contain;border-radius:10px;padding:12px;position:fixed;overflow-y:auto}.nft0-a_head{justify-content:space-between;align-items:center;margin-bottom:10px;display:flex}.nft0-a_available,.nft0-a_unavailable{border-radius:10px;padding:2px 8px;font-size:11px;font-weight:600}.nft0-a_available{background:var(--dsw-alias-state-success-tertiary);color:var(--dsw-alias-state-success-primary)}.nft0-a_unavailable{color:var(--dsw-alias-state-error-primary);background:#f851492e}.nft0-a_currency{opacity:.6;font-size:11px}.nft0-a_headRight{align-items:center;gap:8px;display:inline-flex}.nft0-a_refresh{width:22px;height:22px;color:inherit;cursor:pointer;opacity:.65;background:0 0;border:1px solid #0000;border-radius:6px;justify-content:center;align-items:center;padding:0;transition:background-color .12s,opacity .12s;display:inline-flex}.nft0-a_refresh:hover:not(:disabled){opacity:1;background:#7f7f7f29}.nft0-a_refresh:disabled{cursor:default;opacity:.5}.nft0-a_recharge{height:22px;color:var(--dsw-alias-state-success-primary);cursor:pointer;background:#2ea04329;border:1px solid #3fb95059;border-radius:6px;align-items:center;gap:4px;padding:0 8px;font-size:11px;font-weight:600;transition:background-color .12s,border-color .12s;display:inline-flex}.nft0-a_recharge:hover{background:#2ea04347;border-color:#3fb95099}.nft0-a_rechargePlus{font-size:13px;font-weight:700;line-height:1}.nft0-a_rechargeHint{border-top:1px solid var(--dsw-alias-border-l2);opacity:.7;margin-top:10px;padding-top:8px;font-size:11px;line-height:1.5}.nft0-a_spin{animation:.8s linear infinite nft0-a_balanceRefreshSpin}@keyframes nft0-a_balanceRefreshSpin{0%{transform:rotate(0)}to{transform:rotate(360deg)}}.nft0-a_section+.nft0-a_section{border-top:1px solid var(--dsw-alias-border-l2);margin-top:10px;padding-top:8px}.nft0-a_sectionTitle{letter-spacing:.04em;opacity:.6;margin:0 0 2px;font-size:11px;font-weight:600}.nft0-a_rows{margin:0}.nft0-a_row{justify-content:space-between;align-items:baseline;padding:4px 0;font-size:12px;display:flex}.nft0-a_row dt{opacity:.7;margin:0}.nft0-a_row dd{font-variant-numeric:tabular-nums;margin:0;font-weight:600}.nft0-a_total{font-size:14px}.nft0-a_state,.nft0-a_error{opacity:.8;padding:4px 0;font-size:12px}.nft0-a_error{color:var(--dsw-alias-state-error-primary);opacity:1}.nft0-a_note{background:#d299221f;border:1px solid #d299224d;border-radius:8px;margin-top:10px;padding:8px 10px;font-size:11px;line-height:1.5}.nft0-a_models{flex-direction:column;gap:8px;display:flex}.nft0-a_modelRow{border:1px solid var(--dsw-alias-border-l2);background:#7f7f7f0d;border-radius:8px;padding:6px 8px}.nft0-a_modelHead{justify-content:space-between;align-items:baseline;gap:8px;display:flex}.nft0-a_modelName{overflow-wrap:anywhere;font-size:12px;font-weight:600}.nft0-a_modelRequests{opacity:.6;flex:none;font-size:11px}.nft0-a_modelStats{font-variant-numeric:tabular-nums;opacity:.8;justify-content:space-between;align-items:baseline;gap:8px;margin-top:2px;font-size:11px;display:flex}";
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					...
					children: [
						...
						result !== null && result.ok === false && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
										...
										children: [
											...
											/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
												...
												children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
													...
													"aria-hidden": "true",
													children: "+"
												}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "充值" })]
											}),
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h4", {
										...
										children: [
											/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: "总余额" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", {
											...
											/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
												className: BalanceButton_module_css_default.row,
												children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: "充值余额" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: money(Number(balance.topped_up_balance), balanceCode) })]
											}),
											/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
												className: BalanceButton_module_css_default.row,
												children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", { children: "赠送余额" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dd", { children: money(Number(balance.granted_balance), balanceCode) })]
											})
										]
									})]
								}),
